...
function initProjectModals() {
    const projectData = {
        ...
        tennisfan: {
            title: 'Tennisfan.ru — сервис для любителей тенниса',
            description: 'Веб-сервис для отслеживания теннисных матчей, турниров и статистики. Адаптивный интерфейс, удобный поиск по турнирам и игрокам, интеграция с внешними источниками данных и панель администратора для управления контентом.',
            screenshots: [
                {
                    image: '/static/images/tennisfan_1.png',
                    title: 'Главная страница Tennisfan.ru',
                    description: 'Обзор ближайших турниров и актуальных матчей с фокусом на удобство для любителей тенниса.'
                },
                {
                    image: '/static/images/tennisfan_2.png',
                    title: 'Детальная карточка турнира',
                    description: 'Подробная информация о турнире, сетке, участниках и расписании матчей.'
                },
                {
                    image: '/static/images/tennisfan_3.png',
                    title: 'Страница статистики',
                    description: 'Расширенная статистика по игрокам и матчам с удобной навигацией.'
                },
                {
                    image: '/static/images/tennisfan_4.png',
                    title: 'Адаптивный интерфейс',
                    description: 'Сайт одинаково удобно использовать с ноутбука и мобильного телефона.'
                }
            ]
        },
        'floral-bot': {
            title: 'FloralDetailsBot — Telegram-бот для оформления заказов цветов',
            description: 'Telegram-бот для флористического сервиса, который помогает клиентам выбрать композицию, оформить заказ и получить уведомления о статусе. Бот снижает нагрузку на менеджеров и позволяет принимать заявки 24/7.',
            screenshots: [
                {
                    image: '/static/images/bot_1.png',
                    title: 'Главное меню бота',
                    description: 'Пользователь выбирает формат заказа: готовая композиция, индивидуальный подбор или уточнение деталей.'
                },
                {
                    image: '/static/images/bot_2.png',
                    title: 'Подбор букета',
                    description: 'Диалоговый сценарий с уточняющими вопросами по бюджету, цветам и поводу, чтобы собрать идеальную композицию.'
                },
                {
                    image: '/static/images/bot_3.png',
                    title: 'Оформление и подтверждение заказа',
                    description: 'Сбор контактных данных, времени доставки и комментариев клиента с подтверждением в один клик.'
                },
                {
                    image: '/static/images/bot_4.png',
                    title: 'Уведомления и статус заказа',
                    description: 'Клиент получает уведомления об этапах обработки: принятие заказа, подготовка, передача курьеру и доставка.'
                }
            ]
        }
    };
